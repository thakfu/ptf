...
echo '</tr>';
    ...
    echo '<div align="center"><i>Passing Yards Leaders</i><br>';
...
foreach ($statsService as $player) {
    if ($player['PassAtt'] > 0 && $player['Season'] == $year) {
...
echo '</tr>';
    ...
    echo '<div align="center"><i>Rushing Yards Leaders</i><br>';
    foreach ($topArray as $ta) {
        echo '<img width="100px" src="export/Images/Players/' . str_replace(" ","_",$ta) . '.jpg" onerror="this.src=\'notfound.png\'">'. str_repeat('&nbsp;', 10);
    }
    echo '</div>';
...
foreach ($statsService as $player) {
    if ($player['RushAtt'] > 0 && $player['Season'] == $year) {
...
echo '</tr>';
    ...
    echo '<div align="center"><i>Receiving Yards Leaders</i><br>';
    foreach ($topArray as $ta) {
        echo '<img width="100px" src="export/Images/Players/' . str_replace(" ","_",$ta) . '.jpg" onerror="this.src=\'notfound.png\'">'. str_repeat('&nbsp;', 10);
    }
    echo '</div>';
...
foreach ($statsService as $player) {
    if ($player['Catches'] > 0 && $player['Season'] == $year) {
...
echo '</tr>';
    ...
    echo '<div align="center"><i>Pancake Leaders</i><br>';
    foreach ($topArray as $ta) {
        echo '<img width="100px" src="export/Images/Players/' . str_replace(" ","_",$ta) . '.jpg" onerror="this.src=\'notfound.png\'">'. str_repeat('&nbsp;', 10);
    }
    echo '</div>';
...
foreach ($statsService as $player) {
    if (($player['MissedBlocks'] + $player['Pancakes']) > 0 && $player['Season'] == $year) {
...
echo '<div align="center"><i>Tackles Leaders</i><br>';
foreach ($topArray as $ta) {
    echo '<img width="100px" src="export/Images/Players/' . str_replace(" ","_",$ta) . '.jpg" onerror="this.src=\'notfound.png\'">'. str_repeat('&nbsp;', 10);
}
echo '</div>';
...
echo '<div align="center"><i>Sacks Leaders</i><br>';
foreach ($topArray as $ta) {
    echo '<img width="100px" src="export/Images/Players/' . str_replace(" ","_",$ta) . '.jpg" onerror="this.src=\'notfound.png\'">'. str_repeat('&nbsp;', 10);
}
echo '</div>';
...
echo '<div align="center"><i>Interceptions Leaders</i><br>';
foreach ($topArray as $ta) {
    echo '<img width="100px" src="export/Images/Players/' . str_replace(" ","_",$ta) . '.jpg" onerror="this.src=\'notfound.png\'">'. str_repeat('&nbsp;', 10);
}
echo '</div>';
...
foreach ($statsService as $player) {
    ...
    if ($defender > 0 && $player['Season'] == $year) {
...
echo '<div align="center"><i>Points Leaders</i><br>';
foreach ($topArray as $ta) {
    echo '<img width="100px" src="export/Images/Players/' . str_replace(" ","_",$ta) . '.jpg" onerror="this.src=\'notfound.png\'">'. str_repeat('&nbsp;', 10);
}
echo '</div>';
...
echo '<div align="center"><i>Punting Leaders</i><br>';
foreach ($topArray as $ta) {
    echo '<img width="100px" src="export/Images/Players/' . str_replace(" ","_",$ta) . '.jpg" onerror="this.src=\'notfound.png\'">'. str_repeat('&nbsp;', 10);
}
echo '</div>';
...
foreach ($statsService as $player) {
    ...
    if ($special > 0 && $player['Season'] == $year) {
...
echo '<div align="center"><i>Kick Return Leaders</i><br>';
foreach ($topArray as $ta) {
    echo '<img width="100px" src="export/Images/Players/' . str_replace(" ","_",$ta) . '.jpg" onerror="this.src=\'notfound.png\'">'. str_repeat('&nbsp;', 10);
}
echo '</div>';
...
echo '<div align="center"><i>Punt Return Leaders</i><br>';
foreach ($topArray as $ta) {
    echo '<img width="100px" src="export/Images/Players/' . str_replace(" ","_",$ta) . '.jpg" onerror="this.src=\'notfound.png\'">'. str_repeat('&nbsp;', 10);
}
echo '</div>';
