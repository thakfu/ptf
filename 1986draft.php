...
$stmt = $connection->query('SELECT * FROM ptf_draft_picks d LEFT JOIN ptf_teams t ON d.owner = t.TeamID LEFT JOIN ptf_players y ON y.PlayerID = d.playerID WHERE d.year = "1986" ORDER BY d.round ASC, d.pick ASC');
$picks = array();
