...
//echo 'PTF Website is currently down for maintenance! Details in the morning (2/15)  - Fish';
//exit;
include 'header.php';
...
echo '<b>Check us out on discord!</b>  <a href="https://discord.gg/SYBkaejsae"><img src="images/discord.png"  width="50px"></a><br>';
$slice = 10;
echo '<div id="transmain">';
echo '<h3>Latest Transactions</h3>';
$transInfo = transService('front','','');
