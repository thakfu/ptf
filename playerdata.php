...
$playerInfo = $connection->query("SELECT p.FirstName, p.LastName, p.Position, d.Nickname, d.News, d.notes, d.uniform, d.stickers, d.status, d.custom_awards FROM ptf_players p LEFT JOIN ptf_players_data d ON p.PlayerID = d.PlayerID WHERE p.PlayerID = " . $_GET['PlayerID']);
